...
var year_abs = new Date().getFullYear(); 
var year_element = document.getElementById("year");
year_element.innerHTML=year_abs;


//TIMER CODE
var countDownDate = new Date("Aug,14 2021 13:00:00").getTime();
...
var img_ele = document.getElementById("status-img");
...
var x = setInterval(function() {
  ...
  document.getElementById("timer").innerHTML = "First Edition Releasing In "+ days + "d " + hours + "h "
  + minutes + "m " + seconds + "s ";
